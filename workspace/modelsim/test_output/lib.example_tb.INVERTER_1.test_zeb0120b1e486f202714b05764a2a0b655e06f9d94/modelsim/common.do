...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini C:/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/modelsim/modelsim.ini -wlf {C:/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/test_output/lib.example_tb.INVERTER_1.test_zeb0120b1e486f202714b05764a2a0b655e06f9d94/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/example_tb/INVERTER=1 -g/example_tb/runner_cfg={"active python runner : true,enabled_test_cases : test_zero,output path : C::/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/test_output/lib.example_tb.INVERTER_1.test_zeb0120b1e486f202714b05764a2a0b655e06f9d94/,tb path : C::/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/rtl/sim/example/,use_color : true"} lib.example_tb   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini C:/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/modelsim/modelsim.ini -wlf {C:/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/test_output/lib.example_tb.INVERTER_1.test_zeb0120b1e486f202714b05764a2a0b655e06f9d94/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/example_tb/INVERTER=1 -g/example_tb/runner_cfg={"active python runner : true,enabled_test_cases : test_zero,output path : C::/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/test_output/lib.example_tb.INVERTER_1.test_zeb0120b1e486f202714b05764a2a0b655e06f9d94/,tb path : C::/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/rtl/sim/example/,use_color : true"} lib.example_tb   -L vunit_lib -L lib' failed
...
proc is_test_suite_done {} {
    set fd [open "C:/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/test_output/lib.example_tb.INVERTER_1.test_zeb0120b1e486f202714b05764a2a0b655e06f9d94/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {C:\Users\Mani\AppData\Local\Programs\Python\Python311\python.exe -u example_tb.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\Mani\AppData\Local\Programs\Python\Python311\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\Mani\\AppData\\Local\\Programs\\Python\\Python311\\python.exe', '-u', 'example_tb.py', '--compile'], cwd='C:\\Users\\Mani\\Documents\\Projects\\FPGA\\Training_SPI_slave\\python\\tb\\example', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
