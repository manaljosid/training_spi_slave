...
proc is_test_suite_done {} {
    set fd [open "C:/Users/Mani/Documents/Projects/FPGA/Training_SPI_slave/workspace/modelsim/test_output/lib.spi_slave_tb.receive_one_byte3a1fdfe08b45a7bb5f5c121ee5c172b3a3b62786/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {C:\Users\Mani\AppData\Local\Programs\Python\Python311\python.exe -u spi_slave_tb.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\Mani\AppData\Local\Programs\Python\Python311\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\Mani\\AppData\\Local\\Programs\\Python\\Python311\\python.exe', '-u', 'spi_slave_tb.py', '--compile'], cwd='C:\\Users\\Mani\\Documents\\Projects\\FPGA\\Training_SPI_slave\\python\\tb\\spi_slave_tb.py', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
